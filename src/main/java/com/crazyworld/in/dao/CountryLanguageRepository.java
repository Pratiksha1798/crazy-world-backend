...
public interface CountryLanguageRepository extends JpaRepository<CountryLanguageEntity,String>{
	...
	List<CountryLanguageEntity> findByCountryEntityAndIsOfficialType(CountryEntity countryEntity, IsOfficial isOfficial);
	...
	@Transactional
	@Modifying(clearAutomatically = true)
	//@Query("UPDATE CountryLanguageEntity cle SET cle.isOfficialType = CAST(:isOfficial AS com.crazyworld.in.util.IsOfficial) WHERE cle.language = :language AND cle.countryEntity.code = :countryCode")
